...
> 
> If for some reason you have a regex and don't know if it contains non-embeddable flags or not, the [`has-non-embeddable-flags?`](https://pmonks.github.io/wreck/wreck.api.html#var-has-non-embeddable-flags.3F) function may be of interest.
